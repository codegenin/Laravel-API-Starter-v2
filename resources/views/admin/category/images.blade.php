                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{asset('images/fr.png')}}" alt="french">
                                ...
                                row="10">{{ old('fr_description') }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{asset('images/en.png')}}" alt="french">
                                ...
                                <textarea type="text" name="description" id="edit-media-description"
                            ...
                            <img src="{{asset('images/fr.png')}}" alt="french">
                                ...
                                <textarea type="text" name="fr_description" id="edit-media-fr_description"
